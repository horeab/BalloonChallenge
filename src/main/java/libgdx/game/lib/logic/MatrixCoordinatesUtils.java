...
import libgdx.game.lib.model.CoordinateInfo;
import libgdx.game.lib.model.MatrixWithChangedCells;
import libgdx.game.lib.model.PlayerPosition;
...
public class MatrixCoordinatesUtils {
    ...
    public PlayerPosition fillCurrentPositionInfo(Pair<Integer, Integer> currentPositionCoord, int[][] matrix) {
    ...
    public int getFinalPositionValue(Pair<Integer, Integer> finalPosition, int[][] matrix) {
    ...
    public MatrixWithChangedCells verifyPlaneNeighbours(Pair<Integer, Integer> plane, int[][] matrix, boolean isPlayer1Turn) {
    ...
    public int[][] movePlayer(PlayerPosition playerPosition, Pair<Integer, Integer> nextPosition, int[][] matrix, boolean isPlayer1Turn) {
    ...
    public Pair getRandomUpPosition(Pair<Integer, Integer> currentPosition, int[][] matrix) {
        Pair<Integer, Integer> randomPoint = randomPoint(currentPosition, matrix);
    ...
    private Pair randomPoint(Pair currentPosition, int[][] matrix) {
    ...
    public boolean verifyMoveValidity(Pair<Integer, Integer> nextPosition, int[][] matrix, PlayerPosition playerPosition, Pair currentRandomTornadoNextPosition) {
