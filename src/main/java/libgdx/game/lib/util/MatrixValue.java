...
public enum MatrixValue {
	...
	POINTS                  (3,  true,  true,  false, false, false, false, false,  3,    4,    "points"),
	ARROW_LEFT              (4,  false, false, false, true,  false, false, false,  6,    7,    "cloudleft"),
	ARROW_RIGHT             (5,  false, false, true,  false, false, false, false,  6,    7,    "cloudright"),
	PLANE                   (6,  false, false, false, false, true,  false, false,  3,    5,    "plane"),
	TORNADO                 (7,  true,  true,  false, false, false, true,  true,   1,    2,    "tornado"),
	BLOCKING_CLOUD          (8,  false, false, false, false, false, false, false,  7,    8,    "blockingcloud"),
	;
	//@formatter:on
	private int value;
